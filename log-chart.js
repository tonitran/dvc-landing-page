var ENV = 'nopi';
var prodEndPoint = 'http://dvc-raspberrypi.ucsd.edu:5000';
var noPiEndPoint = 'http://lvh.me:5000/';

var today = new Date();
var chartYear = today.getFullYear();
var chartMonth = today.getMonth() + 1;
var chartDay = today.getDate();
...
chartDayFormatted = ('0' + chartDay).slice(-2);
chartMonthFormatted = ('0' + chartMonth).slice(-2);

var logData = [];
$.getJSON(`http://localhost:5000/logs/${chartYear}/${chartMonthFormatted}/${chartDayFormatted}`,
        function(data) {
